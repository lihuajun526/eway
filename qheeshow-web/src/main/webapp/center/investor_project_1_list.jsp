...
<div class="g-mg-rwap">
    <ul class="g-mg-rtitlst">
        <li onclick="setType(1)" <%=type.intValue() == 1 ? "class='on'" : "class='on1'"%>><a>平台推荐</a></li>
        <li onclick="setType(2)" <%=type.intValue() == 2 ? "class='on'" : "class='on1'"%>><a>关注的项目</a></li>
        <li onclick="setType(3)" <%=type.intValue() == 3 ? "class='on'" : "class='on1'"%>><a>金融顾问</a></li>
    </ul>
    <%
