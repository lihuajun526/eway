...
<div>
    <ul class="wtwx-package-money">
        <li onclick="checkR(this,141,100)">￥<a>100（200分钟）</a></li>
        <li onclick="checkR(this,142,200)" class="on">￥<a>200（400分钟）</a></li>
        <li onclick="checkR(this,145,500)">￥<a>500（1000分钟）</a></li>
    </ul>
